...
const Product = () => {
  ...
  let allImages = [
    "https://images.meesho.com/images/products/497790727/lymol_512.webp?width=512",
    "https://images.meesho.com/images/products/497790727/uxeu2_512.avif?width=512",
    "https://images.meesho.com/images/products/497790727/rjebb_512.avif?width=512",
    "https://images.meesho.com/images/products/497790727/9iywz_512.avif?width=512",
    "https://images.meesho.com/images/products/497790727/rjebb_512.avif?width=512",
  ];
  ...
  const clcHandler = (e) => {
    ...
    if (state === "Add to Cart") setState(navigate("/checkout/cart"));
  };
  ...
  return (
    <Section id="single-product">
      <article id="product-article-1">
        {allImages.map((i, idx) => (
          <img key={idx} src={i} alt="" onClick={() => setImage(i)} />
        ))}
      </article>
  ...
  <p>More Information</p>
        ...
        <div id="soldBy">
          ...
          <h6>
            <span>{Math.round(Math.random() * 400 + 50)}</span>
            Products <span>{Math.floor(Math.random() * 5000 + 100)}</span>{" "}
            Followers
          </h6>
        </div>
        ...
        <div id="information">
          {/* <-- CHANGED: make this a Link to the reviews page for this product */}
            <p>
    <Link
      to={`/product/${id}/reviews`}
      style={{
        textDecoration: "none",
        color: "#b1359e", // darker light version
        display: "inline-flex",
        alignItems: "center",
        gap: "6px",
        fontWeight: "bold",
      ...
      onMouseEnter={(e) => (e.target.style.color = "#7a1567")} // darker hover
      onMouseLeave={(e) => (e.target.style.color = "#b1359e")}
    >
      View All Reviews <FaAngleRight />
        ...
        <div id="meesho-logo">
          ...
          <span>Best Qauality Products from Trusted Supplier</span>
        </div>
      </article>
    </Section>
  );
